...
import com.icici.moneytransfer.databinding.ItemScheduleTransfermoneyBinding
...
class ScheduleRecycleAdapter(val list: List<ScheduleTLResponseItem?>) :
    ...
    inner class FrequentRecycleAdapterVH(val binding: ItemScheduleTransfermoneyBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FrequentRecycleAdapterVH {
        ...
        val binding: ItemScheduleTransfermoneyBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.item_schedule_transfermoney,
            parent,
            false
        )
