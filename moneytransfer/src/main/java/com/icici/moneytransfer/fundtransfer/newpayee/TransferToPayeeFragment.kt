...
import com.icici.moneytransfer.databinding.FragmentTransferToPayeeBinding
...
import com.icici.moneytransfer.databinding.FragmentTransferToPayeemoneyBinding
import com.icici.moneytransfer.fundtransfer.FundTransferViewModel
import java.util.*

class TransferToPayeeFragment : BaseFragment() {

    lateinit var binding: FragmentTransferToPayeemoneyBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_transfer_to_payeemoney, container, false)
     ...
     //       Glide.with(context!!).load(ApiRoutes.bankIConUrl + bank + ".png").into(binding.otherBank)
      ...
      //      Glide.with(context!!).load(ApiRoutes.bankIConUrl + "OTHER" + ".png").into(binding.otherBank)
        ...
        viewModel.mResult.observe(this, {
            (this@TransferToPayeeFragment.activity as MoneyTransferActivity).dismissProgressDialog()
            when (it) {
                is Result.Success<*> -> {
                    when (it.data) {
                        is OneTimeIntiateResponse -> {
                            ...
                            if (it.data.authorization!!.isConfirmationMode == "Y") {
                                ...
                                fromIMPS="yes"
                                (this@TransferToPayeeFragment.activity as MoneyTransferActivity).switchFragment(
        ...
        binding.btnTransfer.setOnClickListener {
            ...
            if (error == "") {
                ...
                (this@TransferToPayeeFragment.activity as MoneyTransferActivity).showProgressDialog()
        ...
        binding.btnBack.setOnClickListener {
            ...
            (this@TransferToPayeeFragment.activity as MoneyTransferActivity)!!.supportFragmentManager.beginTransaction().remove(this@TransferToPayeeFragment).commit()
            (this@TransferToPayeeFragment.activity as MoneyTransferActivity).onBackPressed()  }
