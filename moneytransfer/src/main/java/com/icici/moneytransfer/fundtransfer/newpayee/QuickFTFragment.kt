...
import com.icici.moneytransfer.databinding.FragmentTransferQuickmoneyBinding
...
class QuickFTFragment: BaseFragment() {
    ...
    private lateinit var binding: FragmentTransferQuickmoneyBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_transfer_quickmoney,
            container,
            false
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.mResult.observe(this, { it ->
            (this@QuickFTFragment.activity as MoneyTransferActivity).dismissProgressDialog()
            when (it) {
                is Result.Success<*> -> {
                    ...
                    when (it.data) {
                        is OneTimeIntiateResponse -> {
                            ...
                            if (mOneTimeFTResponse.authorization!!.isConfirmationMode == "Y") {
                                ...
                                (this@QuickFTFragment.activity as MoneyTransferActivity).switchFragment(
        ...
        binding.btnBack.setOnClickListener {
            ...
            (this@QuickFTFragment.activity as MoneyTransferActivity)!!.supportFragmentManager.beginTransaction().
            remove(this@QuickFTFragment).commit()
            (this@QuickFTFragment.activity as MoneyTransferActivity).onBackPressed()
        }
        ...
        binding.btnTransfer.setOnClickListener {
            ...
            if (error == "") {
                ...
                (this@QuickFTFragment.activity as MoneyTransferActivity).showProgressDialog()
