package com.example.myapplication.views.customsearchable.model;
...
public class ResultItem implements Parcelable {
    ...
    public ResultItem () {
        ...
        this.leftIcon = R.drawable.icici_i;
        this.rightIcon = R.drawable.sbi;
    }
    ...
    public void setRightIcon(Integer rightIcon) {
        if (rightIcon != null && rightIcon != 0 && rightIcon != -1) {
            ...
            this.rightIcon = R.drawable.icici_i;
        }
    }
