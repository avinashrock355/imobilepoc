...
class TransferNewPayeeFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentTransferNewPayeeBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_transfer_new_payee,
            container,
            false
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.mResult.observe(this, { it ->
            (this@TransferNewPayeeFragment.activity as DashboardActivity).dismissProgressDialog()
            when (it) {
                is Result.Success<*> -> {
        ...
        binding.btnBack.setOnClickListener {
            ...
            (this@TransferNewPayeeFragment.activity as DashboardActivity)!!.supportFragmentManager.beginTransaction().remove(this@TransferNewPayeeFragment).commit()
            (this@TransferNewPayeeFragment.activity as DashboardActivity).onBackPressed()  }
        binding.btnTransfer.setOnClickListener {
            ...
            if (error == "") {
                ...
                (this@TransferNewPayeeFragment.activity as DashboardActivity).showProgressDialog()
